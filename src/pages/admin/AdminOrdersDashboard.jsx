        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          {orders.map(o => (
            <div key={o.order_id} style={{
              ...
              borderRadius: 'var(--r-10)', padding: '14px 20px',
              ...
              <span style={{ fontSize: 11, fontWeight: 600, color: 'var(--text2)', background: 'var(--surface2)', padding: '2px 8px', borderRadius: 'var(--r)', textTransform: 'capitalize', flexShrink: 0 }}>
