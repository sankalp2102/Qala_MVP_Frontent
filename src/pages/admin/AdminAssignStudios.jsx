...
const S = {
  ...
  navChip: { background: 'rgba(255,255,255,0.15)', color: '#fff', borderRadius: 100, padding: '3px 10px', fontSize: 11, fontWeight: 600, letterSpacing: '.06em', textTransform: 'uppercase', marginLeft: 'auto' },
  ...
  btn: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, fontSize: 14, fontWeight: 500, padding: '11px 20px', borderRadius: 8, border: 'none', cursor: 'pointer', width: '100%' },
